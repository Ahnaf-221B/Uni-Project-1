...
void Time_call_change(char time_str[])
{
    char time_stR[20];
    int i,j,flag=0;
    j=0;
...
apointment_1:
    fgh=0;
    int log_in,i,p=0,maneger_choice,Item_number,q,u=0;
    int cchoice,bill=0,Time,w=0,tt,slent,previos,pxz;
    char item_name[100],passcode[15],password[15];
...
maneger_choice_1 :
            ...
            else if(maneger_choice==3)
            {
                ...
                if(strcmp(passcode,password)==0)
                {
                    ...
                    //scanf("%s",&password);
                    char pardword[10], cnhh;
                    int inn, jnn;
                    for(inn = 0; inn < 15; inn++)
                    {
                        cnhh = getch();
                        if(cnhh == 13)
                            break;
            ...
            else if(maneger_choice==5)
            {
                History();
                break;
            }
            else if(maneger_choice==6)
            {
                goto end_close;
                break;
            }
    ...
    printf("Display Closing in 10 Second");
    delay(1);
    for(int ir=10; ir>=0; ir--)
    {
        printf("\r                                ");
        printf("\rDisplay Closing in %d Second",ir);
        delay(1);
    }
    printf("\r                                    ");
    system("cls");
